...
class HomeController extends Controller
{
  ...
  $slider  = slider::limit(51)->latest()->with('get_slider_description')->get();
  $NEWS  = NEWS::limit(44)->latest()->with('get_NEWS_description')->where('cat_id','=','2')->get();
  $services  =  NEWS::limit(42)->latest()->with('get_NEWS_description')->where('cat_id','=','1')->get();
  $Portfolio  = NEWS::limit(41)->latest()->with('get_NEWS_description')->where('cat_id','=','3')->get();
