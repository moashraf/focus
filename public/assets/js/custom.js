(function () {
    ...
    wind.on("scroll",function () {
        var bodyScroll = wind.scrollTop(),
            ...
            footer = $(".footer"),
            footerinternal = $(".footer-internal"),
            header = $(".header");
        if(bodyScroll > 400){
            ...
            navbarinternal.addClass("nav-scroll"),
            navbar.css("opacity","0"),
            navbarinternal.css("opacity","1"),
            footer.css("display", "none"),
            footerinternal.css("display", "block"),
    ...
    $(window).on("scroll", function(){
        ...
        $('.footer-internal').css("opacity", 1 + $(window).scrollTop() / 300);
    });
